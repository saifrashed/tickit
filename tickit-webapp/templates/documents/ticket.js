				...
				<tr class="top">
					<td colspan="2">
						<table>
							<tr>
								<td class="title">
									<img src="https://tickit.vorm.tech/static/media/tickit_logo.4ceda3b7.png" style="width: 100%; max-width: 300px" />
								</td>
						...
						<table>
							<tr>
								...
								${order.firstName.toLocaleUpperCase() + " " + order.lastName.toLocaleUpperCase()} <br /> ${order.email.toLocaleUpperCase()} <br /> <br /> 
									...
									<b>Datum:</b> ${date.toLocaleDateString()}<br />
